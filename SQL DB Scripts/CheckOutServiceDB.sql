...
CREATE TABLE "Orders" (
	...
	FOREIGN KEY INDEX "FK_Orders_Users_userGuid" ("userGuid"),
	CONSTRAINT "FK_Orders_Users_userGuid" FOREIGN KEY ("userGuid") REFERENCES "Users" ("userGuid") ON UPDATE NO_ACTION ON DELETE CASCADE
);
...
CREATE TABLE "Products" (
	...
	FOREIGN KEY INDEX "FK_Products_Orders_orderGuid" ("orderGuid"),
	CONSTRAINT "FK_Products_Orders_orderGuid" FOREIGN KEY ("orderGuid") REFERENCES "Orders" ("orderGuid") ON UPDATE NO_ACTION ON DELETE CASCADE
);
